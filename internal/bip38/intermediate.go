...
// Magic bytes for intermediate passphrase code
var (
...
func GenerateIntermediateCode(passphrase string, lotNumber, sequenceNumber *uint32) (string, error) {
	...
	var passfactor []byte
	if hasLotSeq {
		// Take SHA256(SHA256(prefactor + ownerentropy))
	...
	// Compute the elliptic curve point G * passfactor
...
// ParseIntermediateCode parses a BIP38 intermediate passphrase code
...
// IsValidIntermediateCode checks if a string is a valid intermediate code format
