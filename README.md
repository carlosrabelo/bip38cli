...
```
bip38cli/cmd/bip38cli/    # Go entry point for the CLI binary
bip38cli/internal/bip38/  # BIP38 domain logic and tests
bip38cli/internal/cli/    # Cobra commands and user interaction flows
bip38cli/internal/errors/ # Error types
bip38cli/internal/logger/ # Logging utilities
bip38cli/internal/metrics/# Metrics utilities
bin/
